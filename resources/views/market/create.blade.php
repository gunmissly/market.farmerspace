            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 chit-chat-layer1-left" style="">
                    <div class="panel panel-default">
                        ...
                        <form id="insertForm" action="{{ url('/') }}" method="POST" >
                            <div class="container-fluid">
                                <div class="gap"></div>
                                <div class="row">
                                        <div class="col-md-12">
                                            <label for="" style="margin-right: 40px">คุณคือ ?</label>
                                            <label class="radio-inline"><input type="radio" name="userradio" value="buyer" checked>ผู้สั่งซื้อ</label>
                                            <label class="radio-inline"><input type="radio" name="userradio" value="farmer">ผู้เสนอขาย</label>
                                        </div>
                                </div>
                                <div class="gap"></div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="ProductName" class="form-control" value="{{ old('ProductName') }}" data-validation="required">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="">สายพันธุ์</label>
                                        <input type="text" name="Species" class="form-control" value="{{ old('Species') }}" data-validation="required">
                                    </div>
                                </div>
                                <div class="gap"></div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="Detail" maxlength="300" rows="6" class="form-control" data-validation="required">{{ old('Detail') }}</textarea>
                                  </div>
                                </div>
                                <div class="gap"></div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="Price" class="form-control" value="{{ old('Price') }}" data-validation="number">
                                    </div>
                                </div>
                                <div class="gap"></div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="Quantity" class="form-control" value="{{ old('Quantity') }}" data-validation="number">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="">วันเก็บเกี่ยว</label>
                                        <input type="date"  data-validation="date" data-validation-format="yyyy-mm-dd" name="HarvestDay" class="form-control" value="{{ old('HarvestDay') }}">
                                    </div> 
                                </div>
                                <div class="gap"></div>
                                 <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <label class="radio-inline"><input type="radio" name="addresradio" value="oldAddress" id="oldAddress" {{ old('addresradio') === 'oldAddress' ? 'checked' : '' }} required>ใช้ที่อยู่เดียวกับประวัติ</label>
                                        <label class="radio-inline"><input type="radio" name="addresradio" value="newAddress" id="newAddress" {{ old('addresradio') === 'newAddress' ? 'checked' : '' }}>ระบุที่อยู่ใหม่</label>
                                    </div>
                                </div>
                                <div class="gap"></div>
                                <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="Address" class="newAddress form-control"  readonly="" value="{{ old('Address') }}">
                                        </div>
                                </div>
                                <div class="gap"></div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="SubDistrict" class="newAddress form-control" readonly="" value="{{ old('SubDistrict') }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="">อำเภอ</label>
                                        <input type="text" name="District" class="newAddress form-control" readonly="" value="{{ old('District') }}">
                                    </div>
                                </div>
                                <div class="gap"></div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="Province" class="newAddress form-control" readonly="" value="{{ old('Province') }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="">รหัสไปรษณีย์</label>
                                        <input type="text" name="Zipcode" class="newAddress form-control" readonly="" value="{{ old('Zipcode') }}">
                                    </div>
                                </div>
                                <div class="gap"></div>
                                ...
                                <button class="btn btn-lg pull-right" style="border-radius: 0px;background-color: #6495ed;color:#fff" type="submit" id="submit"><span>Save</span>
                                </button>
                            </div>
                        </form>
                    </div>
