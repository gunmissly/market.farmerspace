    ...
    $("#fileUpload").on("change", function(event) {
        ...
        if ($.inArray(fileUpload, ['mp4', 'avi', 'mpeg', 'mpg']) == -1) {
            ...
            var uploadTask = storageRef.child('/FarmerspacePicture/imgNews/Type/Video/'+year+'/'+month+'/' + file.name).put(file, metadata);
            ...
            uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, // or 'state_changed'
                ...
                function() {
                    ...
                    $('#blah').show();
                    tempFile = downloadURL;
                    $('#blah').attr('src', downloadURL);
                });
        }
    });
    ...
    function DeleteVideo(id) {
        ...
        var pictureRef = storage.refFromURL(id);
        // Delete the file
