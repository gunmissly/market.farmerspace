                ...
                switch (options.bootstrap) {
                  case true:
                    ...
                    if (options.showPreview) {
                        var prev = $('<div class="col-lg-6 col-md-6 col-xs-6"></div>').appendTo(newRow);
                   ...
                   // }
                    ...
                    var dismiss = $('<div class="col-lg-6 col-md-6 col-xs-6"></div>').appendTo(newRow);
            ...
            previewFile: function(container, file) {
                ...
                switch (type) {
                  case "image":
                    ...
                    var prev = $('<img class="thumbnail img img-responsive" src="' + fileUrl + '" height="64" />').appendTo(container);
                    break;
