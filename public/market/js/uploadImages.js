    ...
    $("#fileUpload").on("change", function(event) {
        ...
        var uploadTask = storageRef.child('/FarmerspacePicture/Product/' + file.name).put(file, metadata);
    ...
    function deleteProductPic() {
        ...
        var pictureRef = storageRef.child('/FarmerspacePicture/Product/' + tempFile);
        // Delete the file
        pictureRef.delete().then(function() {
            // File deleted successfully
            $('#blah').attr('src', '/admin/images/icon_picture.svg');
            document.getElementById("PathFile").value = '';
            document.getElementById("fileDelete").style.display = 'none';
            document.getElementById("fileUpload").value = '';
